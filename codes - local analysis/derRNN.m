...
% samp=[384 395 1484 1495 4538 4549 7670 7681 9627 9638 9641 9652]';
% % LimeResults=lime(rnn,DerInputs(samp,:));
...
idx=1;
for i=1:length(samp)
        res(idx,1)=fit(LimeResults,DerInputs(samp(i,1),:),15,'NumNeighbors',10);
